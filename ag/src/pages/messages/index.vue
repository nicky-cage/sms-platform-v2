    ...
    <div class="template-page">
        <div class="search">
            <a-form-model ref="search" :model="search">
                ...
                <a-form-model-item label="手机号码" prop="phone_full">
                    <a-input v-model="search.phone_full" placeholder="请输入手机号码" />
                </a-form-model-item>
                <a-form-model-item label="回执编号" prop="message_id">
                    <a-input v-model="search.message_id" placeholder="请输入回执编号" />
                </a-form-model-item>
                <a-form-model-item>
        ...
        <div class="table_box">
            <a-table :columns="columns" :data-source="tableList" :pagination="pagination"
                ...
                <span slot="state" slot-scope="text">{{ text === 1 ? '成功' : '未发送' }}</span>
...
export default {
    ...
    data() {
        return {
            ...
            submited: false,
            search: {page: 1, page_size: PAGE_SIZE, content: "", phone_full: "", message_id: "" },
