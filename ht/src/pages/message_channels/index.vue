    ...
    data() {
        return {
            ...
            columns: [
                ...
                {title: "渠道代码", dataIndex: 'code', width: 80},
                {title: "登录账号", dataIndex: 'account', width: 150},
                {title: "协议", dataIndex: 'protocol', width: 80},
                {title: "IP", dataIndex: 'ip', width: 300},
                {title: "端口", dataIndex: 'port', width: 80},
                {title: "状态", dataIndex: 'state', width: 80, scopedSlots: {customRender: 'state'}},
                {title: "费率($)", dataIndex: 'fee', width: 80},
