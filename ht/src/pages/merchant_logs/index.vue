...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                ...
                {title: "对象编号", dataIndex: 'object_id', width: 100},
                {title: "对象名称", dataIndex: 'object_name', width: 150},
                {title: "模块", dataIndex: 'module', width: 100},
                {title: "备注", dataIndex: 'remark', ellipsis: true},
                {title: "操作作时间", dataIndex: 'created', scopedSlots: {customRender: 'created'}, width: 170},
            ],
            tableList: [],
    ...
    methods: {
        ...
        getTableData() {
            ...
            crudService.getRecords(`${BASE_URL}/auth/merchant_logs`, this.search).then(res => {
                let result = res.data;
                if (result.code === 0) {
