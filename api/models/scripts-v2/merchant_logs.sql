...
-- Dump completed on 2022-10-21 16:34:05

alter table merchant_logs add object_id int not null default 0 comment '对象编号';
alter table merchant_logs add object_name varchar(64) not null default '' comment '对象名称';
alter table merchant_logs add module varchar(64) not null default '' comment '模块';
