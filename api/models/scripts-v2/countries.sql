...
CREATE TABLE `countries` (
    ...
    `timezone_offset` decimal(6, 2) NOT NULL DEFAULT '0' COMMENT '八区偏移',
    ...
    KEY(code),
    KEY(phone_prefix)
) ENGINE=InnoDB AUTO_INCREMENT=18000 DEFAULT CHARSET=utf8mb3;

INSERT INTO countries (name_english, name, code, phone_prefix, timezone_offset) VALUES
('Angola','安哥拉','AO','244','-7'),
...
('Netherlands Antilles','荷属安的列斯',' ','599','-12'),
...
update countries set is_support = 1 where name = '菲律宾' limit 1;
update countries set is_support = 1 where name = '中国' limit 1;
